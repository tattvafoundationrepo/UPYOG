...
@Setter
@Getter
public class DeonarConfiguration {
    ...
    // BMC Variables
    @Value("${deonar.kafka.arrival.topic}")
    private String createTopic;

    @Value("${deonar.kafka.update.topic}")
    private String updateTopic;

    @Value("${deonar.kafka.inspection.topic}")
    private String inspectionTopic;

    @Value("${deonar.default.offset}")
    private Integer defaultOffset;

    @Value("${deonar.default.limit}")
    private Integer defaultLimit;

    @Value("${deonar.search.max.limit}")
