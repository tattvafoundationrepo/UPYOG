...
public class EmployeeWorkflowService {
    ...
    public String updateApplicationsStatus(ApplicationStatusRequest request) {
        ...
        if (request.getApplicationStatus().getComment() != null) {
            workflow.setComments(request.getApplicationStatus().getComment().getValue());
        }
        request.getApplicationStatus().getApplicationNumbers().forEach(application -> {
            ...
            userSchemeApplicationRequest.setUserSchemeApplication(
                    updateUserSchemeApplication(usa, request.getApplicationStatus().getAction()));
