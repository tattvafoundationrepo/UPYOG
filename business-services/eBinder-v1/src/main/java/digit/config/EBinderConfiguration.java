...
@AllArgsConstructor
@NoArgsConstructor
public class EBinderConfiguration {
    @Value("${app.timezone}")
    ...
    // BMC Variables
    @Value("${eBinder.kafka.create.topic}")
    private String createTopic;

    @Value("${eBinder.kafka.ceList.topic}")
    private String createCeListTopic;

    @Value("${eBinder.kafka.enquiry.topic}")
    private String peEnquiryTopic;

    @Value("${eBinder.default.offset}")
    private Integer defaultOffset;

    @Value("${eBinder.default.limit}")
    private Integer defaultLimit;

    @Value("${eBinder.search.max.limit}")
