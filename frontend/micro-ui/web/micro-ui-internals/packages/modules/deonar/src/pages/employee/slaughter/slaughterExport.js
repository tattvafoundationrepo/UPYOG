...
const SlaughteringExport = () => {
  ...
  const { fetchExportSlaughterList } = useCollectionPoint({});
  const { data: SlaughterListData } = fetchExportSlaughterList({}, { executeOnLoad: true });
...
export default SlaughteringExport;
