...
const DEDetail = (defaultValues) => {
    ...
    const { data: test, isLoading: isEmployeeLoading } = Digit.Hooks.ebe.useGetEnquiry({"enqId":initialData,type:1}, true);
            ...
            <form>
                {/* <div className="bmc-card-row">
                    <div className="bmc-col-large-header">
                        <div className="bmc-title">{t("EBE_DE_TITLE")}</div>
                    </div>
                </div> */}
                <div className="bmc-card-row">
